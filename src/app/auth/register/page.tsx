...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-[oklch(0.18_0.08_250)] via-[oklch(0.22_0.09_250)] to-[oklch(0.15_0.07_250)] flex items-center justify-center p-6">
